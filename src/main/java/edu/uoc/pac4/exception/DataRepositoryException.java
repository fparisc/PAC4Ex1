...
public class DataRepositoryException extends AppException {
    ...
    public static final String ERROR_DATA_EXISTS = "Data entry with this ID already exists.";
    public static final String ERROR_DATA_NOT_FOUND = "Data entry not found.";
